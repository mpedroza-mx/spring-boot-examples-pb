...
Building a Modern Search Platform Using Spring Boot + MongoDB + Apache Kafka and Apache Solr:

https://medium.com/@mpedroza-mx/building-a-modern-search-platform-using-spring-boot-mongodb-apache-kafka-and-apache-solr-d45ebcba6747?sharedUserId=mpedroza-mx

Create a spring boot app with mongodb + outbox pattern:

https://medium.com/@mpedroza-mx/spring-boot-mongodb-outbox-pattern-dd1c637bf447?sharedUserId=mpedroza-mx

Create spring boot indexer for Apache Solr:

https://medium.com/@mpedroza-mx/create-a-spring-boot-indexer-for-apache-solr-b06e881ee223?sharedUserId=mpedroza-mx
